...
<body>
    ...
    <div>
        ...
        <div class="form">
            <ul>
                <li><span>File Name:</span><asp:TextBox ID="imageName" runat="server"/></li>
                <li><span>File Description:</span><asp:TextBox ID="imageDescription" runat="server"/></li>
                <li><span>File Tags:</span><asp:TextBox ID="imageTags" runat="server"/></li>
                    ...
                    <ul style="width:40em;float:left;clear:left" >
                        ...
                        <li>
                            ...
                            <asp:LinkButton ID="SnapshotBlob" 
                                    ...
                                    CommandArgument='<%# Eval("Uri")%>'
                                    runat="server" Text="Snapshot" oncommand="OnSnapshotImage" />see33e
