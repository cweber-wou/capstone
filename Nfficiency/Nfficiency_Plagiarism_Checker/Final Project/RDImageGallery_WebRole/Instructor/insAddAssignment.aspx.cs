...
public partial class insAddAssignment : System.Web.UI.Page
{
    ...
    private void compileCart()
    {
        ...
        {
            oldItem = cart[i];
            string activeDir = CreateFileOrFolder.getActiveDir(); // retuns current path + FileRepository
        ...
        Response.Redirect("insAssignUpload.aspx?id=" + course_id); //String is redirected here 
    }
    ...
    {
        Response.Redirect("insAssignUpload.aspx?id=" + course_id); //Page is redirected here passing the course_id value 
    }
