...
namespace RDImageGallery_WebRole
{
    ...
    public partial class dynamicBlob : System.Web.UI.Page
    {
        ...
        //Will need to pass in or get container.
            protected void upload_Click(object sender, EventArgs e)
            {
                ...
                if (txtFileName.HasFile)
                {
                    ...
                    this.SaveImage(
                      Guid.NewGuid().ToString(), container.ToString(),
                      txtAssignID.Text,
                      txtFileLink.Text,
                      txtUserID.Text,
            ...
            private CloudBlobContainer GetContainer(String containerName)
            {
                ...
                var account = CloudStorageAccount.FromConfigurationSetting("DataConnectionString");
                var client = account.CreateCloudBlobClient();
                return client.GetContainerReference(RoleEnvironment.GetConfigurationSettingValue(containerName.ToString()));
            }
            ...
            private void SaveImage(string id, string container_AID, string userID_blob, string description, string tags, string fileName, string contentType, byte[] data)
            {
